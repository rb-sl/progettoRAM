...
<div id="regdiv">
    <h3 id="reg">Registro</h3>
        ...
        <ul>
            ...
            <li><a href="#modst">Visualizzare e modificare le informazioni di uno studente</a></li>
        </ul>

    <h4 id="addcl">Aggiungere una classe</h4>
    Dalla pagina di registro, premendo il pulsante <span class="primarycolor">Aggiungi classe</span>, è possibile registrare 
    nel database una nuova classe. Premendo <span class="primarycolor">Promuovi classe precedente</span> e selezionando la 
    ...
    in cui è stata effettuata. Premere il pulsante <span class="primarycolor">Medie e mediane</span> per visualizzare alcune
    statistiche relative ai test.<br>
    Sono possibili le seguenti operazioni sui dati:
    <ul>
        <li>
            <b>Aggiungere prove</b>: premendo <span class="warningcolor">Aggiungi prove</span> è possibile 
    ...
    Premere <span class="warningcolor">Salva</span> per finalizzare l'inserimento o <span class="dangercolor">Annulla</span>
    per scartare le modifiche.

    <h4 id="stcl">Elaborare i dati di una classe</h4>
    Dalla pagina di registro di una classe è possibile premere il pulsante <span class="primarycolor">Elaborazione dati della classe</span>
    ...
    Cliccando sui pulsanti <span class="primarycolor">Medie e mediane</span> o <span class="primarycolor">Colori</span> si possono
    ...
    Premendo il pulsante <span class="warningcolor">Modifica</span> è possibile cambiare le informazioni della classe e 
    gestirne gli studenti. Le modalità sono analoghe a quelle dell'<a href="#addcl">inserimento della classe</a>.
    Premere <span class="warningcolor">Aggiorna classe</span> per salvare le modifiche, <span class="warningcolor">Indietro</span> 
    per annullarle o <span class="warningcolor">Elimina classe</span> per rimuoverla dal database.<br>
    ...
    <h4 id="modst">Visualizzare e modificare le informazioni di uno studente</h4>
    ...
    <span class="warningcolor">Modifica</span> si possono aggiornare cognome, nome e sesso.
</div>