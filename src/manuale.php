...
$test_st = prepare_stmt("SELECT nomet FROM TIPOTEST ORDER BY nomet");
$cl_st = prepare_stmt("SELECT nomec FROM CLTEST ORDER BY nomec");
...
?>                 	
	...
	Il Progetto RAM (Ricerca Attivit&agrave; Motorie) è un'applicazione sviluppata nell'A.S. 2016/2017 all'ITIS G. Fauser di Novara da Roberto Basla 
	e Shahiq Waseem Dar come progetto di maturit&agrave;. &Egrave; stata poi integrata successivamente per migliorarne
	l'usabilit&agrave; e permettere calcoli statistici pi&ugrave; potenti ed efficienti.<br>
	<h4>Contatti</h4>
    <b>Roberto Basla</b><br>
    E-mail: roberto.basla164@gmail.com<br>
</div>
<?php show_postmain(); ?>